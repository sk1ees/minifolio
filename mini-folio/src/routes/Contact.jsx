            ...
            <div className="container w-[100%] borderColor h-auto mt-24 p-4 grid gap-3 contactcss bg-[#212121] m-auto rounded-lg">
                <div className=" rounded-lg flex flex-col gap-3 px-1 py-4 mx-4">
                    <div className="">
                        ...
                        <div className=" mb-3">
                            <h1 className='text-[36px] text-white font-bold mt-6'>Design Enquiries</h1>
                        </div>
                        <div className="">
                            <p className='text-[16px] text-[#C0C0C0] leading-relaxed'>Got an idea and need design help? Reach out now</p>
                        </div>
                    </div>
                </div>
