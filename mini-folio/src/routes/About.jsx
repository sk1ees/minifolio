        ...
        <>
            <div className="container w-[100%] borderColor h-auto mt-24 p-4 grid gap-3 aboutcss bg-[#212121] m-auto rounded-lg ">
                <div className=" rounded-lg flex flex-col gap-3 px-1 py-4 mx-4">
                    ...
                    <div className="">
                        <p className='text-[18px] text-[#C0C0C0] leading-relaxed'>I'm Deep Sarkar, a web developer and video editor from Siliguri, West Bengal. I’m passionate about creating innovative, user-centric interfaces and pushing the limits <br /> of front-end design.</p>
                    </div>
                </div>
                ...
                <div className=" rounded-lg mx-4">
                    ...
                    <p className='text-[18px] text-[#C0C0C0] leading-relaxed'>Deep Sarkar, pursuing a bachelor’s degree in Computer Application in Siliguri, WB, is committed to staying current with the latest tech and design trends. Actively engaged in the LinkedIn community, he regularly takes part in design and coding challenges.</p>
                    <p className='text-[18px] text-[#C0C0C0] leading-relaxed mt-9'> Outside of work, Deep enjoys video editing, exploring Dribbble for new ideas, and balancing his time with <br /> gaming to recharge his creativity.</p>
                </div>
                <div className=" rounded-lg mx-4 ">
