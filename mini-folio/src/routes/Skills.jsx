...
const About = () => {
  ...
  const skillsItem = [
    ...
    {
      image:
        "https://cdn2.iconfinder.com/data/icons/designer-skills/128/code-programming-css-style-develop-layout-language-512.png",
    },
    {
      image:
  ...
  const toolItem = [
    ...
    {
      image:
        "https://cdn1.iconfinder.com/data/icons/designer-skills/128/premiere-256.png",
    },
    {
      image:
        "https://cdn1.iconfinder.com/data/icons/adobe-family/512/Premiere-256.png",
    },
    {
      image:
        "https://cdn1.iconfinder.com/data/icons/designer-skills/128/photoshop-512.png",
    },
  ];
  useGSAP(() => {
    gsap.from(".skillcss", {
          ...
          <div className="">
            ...
            <div className="">
              <p className="text-[16px] text-[#C0C0C0] leading-relaxed">
                During my programming and designing journey , these are the
                skills that i am familiar while using it.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-wrap gap-5 items-center justify-center  ">
              {skillsItem.map((item) => (
                <div className="w-[100px] h-[100px] rounded-xl bg-[#373737] flex items-center justify-center ">
                  <div
                    className="w-[70%] h-[70%] rounded-full    bg-cover"
